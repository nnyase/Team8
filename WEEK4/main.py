...
from utils.meanIou import evaluateTextBoxes
...
def parse_args():
    ...
    parser.add_argument('-ldType', '--local_des_type', type=str, default = "all", help='Indicate which method for generating local descriptors.')
