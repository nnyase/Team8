...
def parse_args():
    ...
    parser.add_argument('-tRem', '--text_rem', default = "no", type = str, help='Indicate if text boxes has to be detected')
            ...
            for level in levels:
                for num in bins:
                    ...
                    if not os.path.exists(folderPath):
                        ...
                        computeDescriptors(args.query_dir, folderPath, color_space, num, histGenFunc, level, maskFolder)
