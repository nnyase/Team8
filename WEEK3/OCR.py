...
results=saveBestKmatches_Text(outputPath_BBDD, outputPath_qsd1, 5, 1)
print(results)
...
# results1=np.load(outputPath_BBDD+"bbdd_00000.npy")
# results2=np.load(outputPath_qsd1+"00000.npy")
# print(results2)
# print(type(results2))
# h=np.array2string(results2)
# print(type(h))
# print(len(h))
#desc=getDistance2Strings(results1,results2,1)
#print(desc)
