...
def saveBestKmatches_Text(bbddDescriptorsPath, qDescriptorsPath, k, distanceFunc):
    ...
    distanceFunc : int (This int value will select which formula will be used)
...
#results=saveBestKmatches_Text(outputPath_BBDD, outputPath_qsd1, 5, 4)
#print(results)
...
#results1=loadNPY(outputPath_BBDD)


#saveBestKmatchesOld(outputPathbbdd, outputPath, 5, 3)
#desc=getDistance2Strings("texwewe  t","tes  wet4 ",34)
