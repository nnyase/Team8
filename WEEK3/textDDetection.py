...
def detectTextBoxes(inputPath, outputPath,storePKL, multiplePaintings = "No", maskDir = None, numberOfFile = -1):
    ...
    storePKL   : if true it stores the PKL file 
    ...
    # Store result if flag activated
    if storePKL == True:
